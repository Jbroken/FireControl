...
public interface UnitMapper {
    ...
    //得到商铺根据商铺类型
    @Select("select unitid,unitname,checkstate from unit where unitproperty = #{type}")
	List<UnitType> getUnitByType(String type);
	...
	List<UnitChildren> getChildrenById(int id);

	int updateCheckstate(@Param(value="unitid")Integer unitid, @Param(value="checkstate")int checkstate, @Param(value="checktype") Integer checktype);
	//获得需整改检查的商铺
