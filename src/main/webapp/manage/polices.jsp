    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="">
              ...
              <div class="form-group">
                  <label for="policestation" class="control-label">所属派出所</label>
                      <select id="policestation" name="policestation" class="form-control selectpicker" style="text-align:left"
								data-style="btn-sm">
