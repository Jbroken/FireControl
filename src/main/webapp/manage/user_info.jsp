...
<body>
	<form action="saveuser" name="userForm" id="userForm" target="result" method="post" onsubmit="return checkInfo();">
	...
	<table border="0" cellpadding="0" cellspacing="0">
		...
		<tr class="info">
			<th>名　称:</th>
			<td><input type="text" name="relname" id="relname" class="input_txt" value="${user.relname }"/></td>
		</tr>
		<tr class="info">
			<th>角　色:</th>
			<td>
			...
			<c:forEach items="${roleList}" var="role">
				<option value="${role.roleid }">${role.usertype }</option>
			</c:forEach>
			</select>
			</td>
		</tr>
